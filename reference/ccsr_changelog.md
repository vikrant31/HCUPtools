...
#> Error in download_changelog_file(changelog_url): Could not locate change log file for this version. Change logs may not be available for all versions. Try visiting the HCUP CCSR archive page: https://hcup-us.ahrq.gov/toolssoftware/ccsr/ccsr_archive.jsp

# View change log in default PDF viewer
ccsr_changelog(version = "v2026.1", format = "view")
#> Error in ccsr_changelog(version = "v2026.1", format = "view"): Could not locate change log file for this version. Change logs may not be available for all versions. Try visiting the HCUP CCSR archive page: https://hcup-us.ahrq.gov/toolssoftware/ccsr/ccsr_archive.jsp

# Extract text from change log PDF (requires pdftools package)
changelog_text <- ccsr_changelog(version = "v2026.1", format = "extract")
#> Error in ccsr_changelog(version = "v2026.1", format = "extract"): Could not locate change log file for this version. Change logs may not be available for all versions. Try visiting the HCUP CCSR archive page: https://hcup-us.ahrq.gov/toolssoftware/ccsr/ccsr_archive.jsp
cat(changelog_text)
#> Error: object 'changelog_text' not found
# }
```
